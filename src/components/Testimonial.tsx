  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Я занималась по учебникам три года и топталась на месте. С этим тьютором за месяц начала читать статьи на английском и перестала бояться писать. Это другой уровень.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Мария К.</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Уровень B1, занимается 6 недель</p>
        </div>
      </div>
    </section>
  )
