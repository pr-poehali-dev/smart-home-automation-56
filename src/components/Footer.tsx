      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-4">
            <p className="font-serif text-2xl tracking-wide text-foreground mb-4">LinguaAI</p>
            <p className="text-sm text-muted-foreground leading-relaxed">
              AI-тьютор английского для уровней A2–B1. Практика без скуки.
            </p>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-muted-foreground">
            &copy; {new Date().getFullYear()} LinguaAI. Все права защищены.
          </p>
          <p className="text-xs text-muted-foreground">Создано с намерением учить</p>
        </div>
      </div>
    </footer>
  )
