      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Оставьте свой email — и я пришлю вам первую сессию с заданиями. Никаких подписок, просто практика.
            </p>
            ...
            >
              <div>
                ...
                <a href="mailto:hello@linguaai.ru" className="text-foreground hover:text-sage transition-colors">
                  hello@linguaai.ru
                </a>
              </div>
              <div>
                <p className="text-xs tracking-widest uppercase text-muted-foreground mb-2">Для кого</p>
                <p className="text-foreground">Уровень A2–B1</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Ваш текущий уровень, цели, вопросы..."
                  required
                />
              </div>
              <button
